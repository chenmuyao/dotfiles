...
myBrowser = "brave-browser"                             # My web browser of choice
...
##### COLORS #####
colors = [["#2b2b2b", "#2b2b2b"], # panel background
          ["#5a647e", "#5a647e"], # background for current screen tab
          ["#f9f7f3", "#f9f7f3"], # font color for group names
          ["#a5c261", "#a5c261"], # border line color for current tab
          ["#6d9cbe", "#6d9cbe"], # border line color for other tab and odd widgets
          ["#da4939", "#da4939"], # color for the even widgets
          ["#ffc66d", "#ffc66d"]] # window name
...
def init_widgets_list():
    widgets_list = [
               ...
               widget.GroupBox(font="DeDaoJinKai",
                        fontsize = 11,
                        margin_y = 3,
                        margin_x = 0,
                        padding_y = 5,
...
if __name__ in ["config", "__main__"]:
    screens = [Screen(top=bar.Bar(widgets=init_widgets_list(), opacity=0.95, size=20)),
